        ...
        >
          ...
          {step === 'otp' && (
            <div>
              ...
              <div style={{ fontSize: 16, color: 'var(--text-3)', marginBottom: 6 }}>
                6-digit code sent to
              </div>
              <div style={{ fontSize: 16, fontWeight: 700, color: 'white', marginBottom: 26 }}>
                a***@agilysys.com
              </div>
              ...
              >
                {otp.map((digit, i) => (
                  <input
                    ...
                    className="mono"
                    style={{
                      width: 54,          // ✅ FIX: fixed width, not flex:1
                      flexShrink: 0,
                      textAlign: 'center',
                      padding: '16px 0',
                      border: i === 0
              ...
              <button onClick={handleSuccess} className="btn-grad">
                Verify &amp; Sign In ✓
              </button>

              <div
                style={{ textAlign: 'center', marginTop: 14, fontSize: 14, color: 'var(--text-3)', cursor: 'pointer' }}
                onClick={() => setStep('customer-number')}
              >
                ← Different customer number
              </div>
